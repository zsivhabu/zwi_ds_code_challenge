...
export default defineComponent({
  ...
  setup: function (props) {
    ...
    const selectOptionsFromStore = useSelectLists().hexIdList;
    const selectOptionsFromServer = new SelectListService().getSelectOptions('h3_level8_index',true);
