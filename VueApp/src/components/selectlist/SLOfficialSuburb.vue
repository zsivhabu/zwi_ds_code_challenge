...
export default defineComponent({
  ...
  setup: function (props) {
    ...
    const selectOptionsFromStore = useSelectLists().officialSuburbList;
    const selectOptionsFromServer = new SelectListService().getSelectOptions('official_suburb',true);
...
<template>
  <generic-server-select-list
      ...
      store-method-name="officialSuburbList"/>
</template>