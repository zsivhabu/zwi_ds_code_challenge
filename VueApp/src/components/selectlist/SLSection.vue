...
export default defineComponent({
  ...
  setup: function (props) {
    ...
    const selectOptionsFromStore = useSelectLists().sectionList;
    const selectOptionsFromServer = new SelectListService().getSelectOptions('section',true);
