...
export default defineComponent({
  ...
  setup: function (props) {
    const selectOptionsFromStore = useSelectLists().causeCodeList;
    const selectOptionsFromServer = new SelectListService().getSelectOptions('cause_code',true);
...
<template>
  <generic-server-select-list
      ...
      store-method-name="causeCodeList"/>
</template>