...
export default defineComponent({
  ...
  setup: function (props) {
    ...
    const selectOptionsFromStore = useSelectLists().branchList;
    const selectOptionsFromServer = new SelectListService().getSelectOptions('branch',true);
